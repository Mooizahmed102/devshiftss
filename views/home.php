...
<head>
    ...
    <meta name="description" content="devshifts ">

    <!-- ========== Page Title ========== -->
    <title>devshifts </title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="assets/img/devshifts.png" class="logo" alt="Logo">
                    </a>
                </div>
   ...
   <!-- Start Banner 
    ============================================= -->
    <div id="homee" class="banner-area with-fixed-nav">
            ...
            <div class="double-items">
                <div class="row align-center">
                    ...
                    <div class="col-lg-6 info">
                        <h2 class="wow fadeInDown" data-wow-duration="1s">Generate More <strong>Traffic</strong> in your Website</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="single-item col-lg-4 col-md-6">
                            <div class="item wow fadeInUp" data-wow-delay="400ms">
                                ...
                                <h4>Link Building</h4>
                                <p>
                                    Favourite tolerably engrossed. Truth short folly court why she their balls Excellence super power.
                                </p>
                            </div>
                        </div>
                        <!-- End Single Item -->
    ...
    <!-- Start Services Area
    ============================================= -->
    <div id="services" class="services-area carousel-shadow bg-gray default-padding-top">
        <!-- Fixed Shape  -->
        ...
        <div class="container">
            ...
            <div class="services-items wow fadeInUp services-carousel owl-carousel owl-theme">
                <!-- Single Item -->
                <div class="item">
                    <div class="icon">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 item">
                        <div class="f-item about">
                            <img src="assets/img/shape/devshifts.png" alt="Logo">
                            <div class="address">
                                <ul>
                                    <li>
                                        <div class="icon">
